...
const confirmDelete = require('../models');

exports.get_landing = (req, res, next) =>
    res.render('landing', { title: 'Express from David with Controllers' });
...
exports.show_leads = (req, res, next) => {
    models.Lead.findAll().then(leads => {
        res.render('landing', { title: 'Express from David with Controllers', leads: leads });
    })
}
...
exports.edit_lead = (req, res, next) => {
    return models.Lead.update({
        id: parseInt(req.params.lead_id),
        name: req.body.lead_name,
        email: req.body.lead_email
    }, {
        where: {
